...
describe("solana_solquad_excercise", async () => {
  ...
  const program = new Program<SolanaSolquadExcercise>(idl as SolanaSolquadExcercise, programId, provider)
  const program2 = new Program<SolanaSolquadExcercise>(idl as SolanaSolquadExcercise, programId, provider2)
